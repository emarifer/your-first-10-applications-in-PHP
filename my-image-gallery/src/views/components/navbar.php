<nav class="flex justify-start items-center px-8 py-2 gap-8 bg-slate-800 fixed top-0 left-0 right-0 z-10">
    <a href="?view=home">
        <svg class="w-12 fill-current" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.001 512.001" xml:space="preserve">
    ...
    <ul class="flex justify-start gap-4 items-center">
        ...
        <li><a href="?view=view">My images</a></li>
    </ul>
</nav>